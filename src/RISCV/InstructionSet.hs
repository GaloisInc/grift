...
instructionSet :: EncodeMap arch -> SemanticsMap arch -> InstructionSet arch
...
opBitsFromOpcode :: InstructionSet arch -> Opcode arch fmt -> OpBits fmt
...
opcodeFromOpBits :: InstructionSet arch -> OpBits fmt -> Either (Opcode arch 'X) (Opcode arch fmt)
...
semanticsFromOpcode :: InstructionSet arch -> Opcode arch fmt -> Formula arch fmt
