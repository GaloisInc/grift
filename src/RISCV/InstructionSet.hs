...
type SemanticsMap arch exts = MapF (Opcode arch exts) (InstFormula arch exts)
...
semanticsFromOpcode :: InstructionSet arch exts -> Opcode arch exts fmt -> InstFormula arch exts fmt
