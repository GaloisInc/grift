...
import Data.Parameterized.TH.GADT
    ...
    , structuralTypeOrd
    , TypePat(TypeApp, AnyType)
    )
import GHC.TypeLits ( KnownNat, Nat )
import GRIFT.BitVector.BVApp
import SoftFloat
    ( ExceptionFlags(ExceptionFlags), Result(..), RoundingMode(..) )
...
evalBVFloatAppM :: Monad m
                ...
                -> BVFloatApp expr w
                -> m (BV.BV w)
evalBVFloatAppM eval (Ui32ToF16App rmE xE) = cr <$> (ui32ToF16 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (Ui32ToF32App rmE xE) = cr <$> (ui32ToF32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (Ui32ToF64App rmE xE) = cr <$> (ui32ToF64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (I32ToF16App rmE xE) = cr <$> (i32ToF16 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (I32ToF32App rmE xE) = cr <$> (i32ToF32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (I32ToF64App rmE xE) = cr <$> (i32ToF64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (Ui64ToF16App rmE xE) = cr <$> (ui64ToF16 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (Ui64ToF32App rmE xE) = cr <$> (ui64ToF32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (Ui64ToF64App rmE xE) = cr <$> (ui64ToF64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (I64ToF16App rmE xE) = cr <$> (i64ToF16 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (I64ToF32App rmE xE) = cr <$> (i64ToF32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (I64ToF64App rmE xE) = cr <$> (i64ToF64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16ToUi32App rmE xE) = cr <$> (f16ToUi32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16ToUi64App rmE xE) = cr <$> (f16ToUi64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16ToI32App rmE xE) = cr <$> (f16ToI32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16ToI64App rmE xE) = cr <$> (f16ToI64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32ToUi32App rmE xE) = cr <$> (f32ToUi32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32ToUi64App rmE xE) = cr <$> (f32ToUi64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32ToI32App rmE xE) = cr <$> (f32ToI32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32ToI64App rmE xE) = cr <$> (f32ToI64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64ToUi32App rmE xE) = cr <$> (f64ToUi32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64ToUi64App rmE xE) = cr <$> (f64ToUi64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64ToI32App rmE xE) = cr <$> (f64ToI32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64ToI64App rmE xE) = cr <$> (f64ToI64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16ToF32App rmE xE) = cr <$> (f16ToF32 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16ToF64App rmE xE) = cr <$> (f16ToF64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32ToF16App rmE xE) = cr <$> (f32ToF16 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32ToF64App rmE xE) = cr <$> (f32ToF64 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64ToF16App rmE xE) = cr <$> (f64ToF16 <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64ToF32App rmE xE) = cr <$> (f64ToF32 <$> (bvToRM <$> eval rmE) <*> eval xE)

evalBVFloatAppM eval (F16RoundToIntApp rmE xE) = cr <$> (f16RoundToInt <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16AddApp rmE xE yE) = cr <$> (f16Add <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F16SubApp rmE xE yE) = cr <$> (f16Sub <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F16MulApp rmE xE yE) = cr <$> (f16Mul <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F16MulAddApp rmE xE yE zE) = cr <$> (f16MulAdd <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE <*> eval zE)
evalBVFloatAppM eval (F16DivApp rmE xE yE) = cr <$> (f16Div <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F16RemApp rmE xE yE) = cr <$> (f16Rem <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F16SqrtApp rmE xE) = cr <$> (f16Sqrt <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F16EqApp xE yE) = crb <$> (f16Eq <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F16LeApp xE yE) = crb <$> (f16Le <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F16LtApp xE yE) = crb <$> (f16Lt <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F16EqSignalingApp xE yE) = crb <$> (f16EqSignaling <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F16LeQuietApp xE yE) = crb <$> (f16LeQuiet <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F16LtQuietApp xE yE) = crb <$> (f16LtQuiet <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F16IsSignalingNaNApp xE) = crb <$> (f16IsSignalingNaN <$> eval xE)

evalBVFloatAppM eval (F32RoundToIntApp rmE xE) = cr <$> (f32RoundToInt <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32AddApp rmE xE yE) = cr <$> (f32Add <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F32SubApp rmE xE yE) = cr <$> (f32Sub <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F32MulApp rmE xE yE) = cr <$> (f32Mul <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F32MulAddApp rmE xE yE zE) = cr <$> (f32MulAdd <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE <*> eval zE)
evalBVFloatAppM eval (F32DivApp rmE xE yE) = cr <$> (f32Div <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F32RemApp rmE xE yE) = cr <$> (f32Rem <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F32SqrtApp rmE xE) = cr <$> (f32Sqrt <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F32EqApp xE yE) = crb <$> (f32Eq <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F32LeApp xE yE) = crb <$> (f32Le <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F32LtApp xE yE) = crb <$> (f32Lt <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F32EqSignalingApp xE yE) = crb <$> (f32EqSignaling <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F32LeQuietApp xE yE) = crb <$> (f32LeQuiet <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F32LtQuietApp xE yE) = crb <$> (f32LtQuiet <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F32IsSignalingNaNApp xE) = crb <$> (f32IsSignalingNaN <$> eval xE)

evalBVFloatAppM eval (F64RoundToIntApp rmE xE) = cr <$> (f64RoundToInt <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64AddApp rmE xE yE) = cr <$> (f64Add <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F64SubApp rmE xE yE) = cr <$> (f64Sub <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F64MulApp rmE xE yE) = cr <$> (f64Mul <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F64MulAddApp rmE xE yE zE) = cr <$> (f64MulAdd <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE <*> eval zE)
evalBVFloatAppM eval (F64DivApp rmE xE yE) = cr <$> (f64Div <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F64RemApp rmE xE yE) = cr <$> (f64Rem <$> (bvToRM <$> eval rmE) <*> eval xE <*> eval yE)
evalBVFloatAppM eval (F64SqrtApp rmE xE) = cr <$> (f64Sqrt <$> (bvToRM <$> eval rmE) <*> eval xE)
evalBVFloatAppM eval (F64EqApp xE yE) = crb <$> (f64Eq <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F64LeApp xE yE) = crb <$> (f64Le <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F64LtApp xE yE) = crb <$> (f64Lt <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F64EqSignalingApp xE yE) = crb <$> (f64EqSignaling <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F64LeQuietApp xE yE) = crb <$> (f64LeQuiet <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F64LtQuietApp xE yE) = crb <$> (f64LtQuiet <$> eval xE <*> eval yE)
evalBVFloatAppM eval (F64IsSignalingNaNApp xE) = crb <$> (f64IsSignalingNaN <$> eval xE)
